            ...
            if (ret < -1) {
                ...
                if (read_bytes <= 0) {
                    if (read_bytes == 0) {
                        ...
                        if (isOwner && cacheProperty[cacheToClient[clientIndex]] != DOWNLOADED && cacheProperty[cacheToClient[clientIndex]] != EMPTY) {
